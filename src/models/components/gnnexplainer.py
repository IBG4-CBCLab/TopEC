...
from src.models.components.explainer import (
    Explainer,
    clear_masks,
    set_masks,
)
...
class GNNExplainer(Explainer):
    ...
    def explain_graph(self, x, pos, edge_index, **kwargs):
        ...
        prediction = self.get_initial_prediction(x=x, pos=pos, edge_index=edge_index, batch=batch)
        ...
        for epoch in range(1, self.epochs + 1):
            ...
            _, out = self.model(x=h, pos=pos, edge_index=edge_index, batch=batch, **kwargs)
